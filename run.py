...
from src.models import AlbertForPromptFinetuning, BertForPromptFinetuning, RobertaForPromptFinetuning, resize_token_type_embeddings
...
def main():
    ...
    if data_args.prompt:
        if data_args.prompt_path is not None:
            ...
            prompt_list = []
            with open(data_args.prompt_path, encoding="utf-8") as f:
                for line in f:
                    line = line.strip()
            ...
            if data_args.template_path is not None:
                with open(data_args.template_path, encoding="utf-8") as f:
            ...
            if data_args.mapping_path is not None:
                ...
                with open(data_args.mapping_path, encoding="utf-8") as f:
                    mapping_list = []
                    for line in f:
                        line = line.strip()
